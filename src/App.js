      ...
      return (
        <div className = "body-container">
          <div className = "page-container centralize logged-out">
            ...
            />
            <br /><br />
            <div style={{display:'inline-block',maxWidth:500}}>Woolaroo is an open-source Google platform that helps indigenous language organizations build their own photo-translation web-apps
            </div><br />
            <span style={{margin:8}}>
              <Button 
                onClick={() => this.authAction_()}
