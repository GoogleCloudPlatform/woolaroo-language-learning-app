...
class ThemePage extends React.Component {
  ...
  async fetchData() {
    ...
    try {
      ...
      const { organization_name, organization_url, app_name, privacy_policy } = this.state.data;
      this.savedData = {
  ...
  handleChange_app_name = (e) => {
    ...
    this.setState({disabled:(newvalue === this.savedData.app_name)});
  };
        ...
        <div>
            ...
            <div className={classes.newSection}>
                ...
                <TextField
                  ...
                  className={classes.textField}
                  margin="normal"
                  onChange={this.handleChange_app_name}
                />
                ...
                <form className={classes.root} autoComplete="off">
                  <FormControl required className={classes.formControl}>
                    ...
                    <FormHelperText>
                      The primary language that you are using
                    </FormHelperText>
                  </FormControl>
                </form>
            </div>
